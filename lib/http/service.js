...
module.exports = (container) => {
  ...
  // Register VG app-user routes before the generic /app-users/:id routes.
  // Otherwise literal segments such as `settings` and `telemetry` are
  // captured as app-user IDs and fail integer validation.
  require('../resources/vg-telemetry')(service, endpoint, anonymousEndpoint);
  ...
  require('../resources/vg-form-access')(service, endpoint);
  require('../resources/vg-enketo-status')(service, endpoint);
