...
module.exports = (container) => {
  ...
  require('../resources/vg-web-user-totp')(service, endpoint);
  require('../resources/vg-user-ip-whitelist')(service, endpoint);
  require('../resources/vg-telemetry')(service, endpoint, anonymousEndpoint);
  require('../resources/vg-enketo-status')(service, endpoint);
  require('../resources/vg-settings')(service, endpoint);
