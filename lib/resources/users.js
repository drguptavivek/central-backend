...
module.exports = (service, endpoint, anonymousEndpoint) => {
  ...
  if (oidc.isEnabled()) {
    ...
    service.post('/users/reset/initiate', endpointByInvalidateQuery(({ Users, mail, Audits, VgUserResetRateLimit }, { auth, body, query }, request) => {
      ...
      const logAttempt = () => Audits.log(null, 'user.reset.initiate', null, {
