...
const problems = {
  user: {
    ...
    // VG: TOTP verification required for web user
    totpRequired: problem(403.3, () => 'Two-factor authentication (TOTP) is required for your account. Please complete the verification step.'),

    // VG: IP not whitelisted for bearer token access
    ipNotWhitelisted: problem(403.4, () => 'Access from your IP address is not allowed. Please contact your administrator to whitelist your IP.'),
