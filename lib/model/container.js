...
const withDefaults = (base, queries) => {
  const defaultQueries = {
    ...
    VgWebUserAuth: require('./query/vg-web-user-auth'),
    VgUserResetRateLimit: require('./query/vg-user-reset-rate-limit'),
    VgAppUserIpRateLimit: require('./query/vg-app-user-ip-rate-limit'),
    VgWebUserTotp: require('./query/vg-web-user-totp'),
    VgUserIpWhitelist: require('./query/vg-user-ip-whitelist'),
    VgTelemetry: require('./query/vg-telemetry'),
    VgEnketoStatus: require('./query/vg-enketo-status'),
    VgSettings: require('./query/vg-settings'),
  };
