...
const create = (actor, expiresAt, totpVerified = true) => ({ one }) => {
...
// VG: Mark session as TOTP verified after successful 2FA verification
...
module.exports = { create, getByBearerToken, terminateByActorId, trimByActorId, terminate, reap, markTotpVerified };
