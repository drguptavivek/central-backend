...
const { table, embedded } = require('../frame/util');
...
VgFieldKeyAuth.FieldKey = Frame.define(table('field_keys'), 'projectId', readable);

const vgFieldKeyAuthUnjoiner = unjoiner(VgFieldKeyAuth, VgFieldKeyAuth.FieldKey);
